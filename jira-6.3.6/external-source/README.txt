...
http://docs.atlassian.com/jira/docs-063/Importing+Data+from+Bugzilla
http://docs.atlassian.com/jira/docs-063/Importing+Data+From+Mantis

 - customize/write a service to work with JIRA:

http://docs.atlassian.com/jira/docs-063/Services
...
source
(http://docs.atlassian.com/jira/docs-063/Building+JIRA+from+Source). The
