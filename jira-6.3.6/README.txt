----------------------------------------------
JIRA 6.3.6-#6336 README
----------------------------------------------

Thank you for downloading JIRA 6.3.6. This distribution comes with a
...
2. Set the JAVA_HOME variable to where you installed Java. The Windows
   ...
   http://docs.atlassian.com/jira/docs-063/Installing+Java

3. Set your JIRA Home Directory.
   Instructions on how to set your JIRA Home Directory can be found here:

   http://docs.atlassian.com/jira/docs-063/Setting+your+JIRA+Home+Directory
...
http://docs.atlassian.com/jira/docs-063/Installing+JIRA
...
http://docs.atlassian.com/jira/docs-063/
